...
class PasswordInput extends Input<String, PasswordValidationFailure> {
  PasswordInput.dirty(String value) : super(value);
  PasswordInput.pure() : super("");
  @override
  PasswordValidationFailure? validator() {
    if (value.isEmpty) {
      return const PasswordValidationFailure.empty();
    }
    if (value.length <= 6) {
